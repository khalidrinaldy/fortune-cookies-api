...
func InitRoute(e *echo.Echo) {
	...
	e.PUT("/product/:product_id", repository.UpdateProduct(database),middlewares.IsLoggedIn())
	e.DELETE("/product/:product_id", repository.DeleteProduct(database), middlewares.IsLoggedIn())
